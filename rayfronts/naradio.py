...
from rayfronts.base import LangSpatialGlobalImageEncoder
...
class NARadioEncoder(LangSpatialGlobalImageEncoder):
    ...
    projection to project the patch-wise tokens to SIGLIP or CLIP language
    aligned feature spaces. The model computes na-radio spatial or global
    features by default and exposes functions to project those features to
    Siglip, or CLIP feature spaces.
    """
